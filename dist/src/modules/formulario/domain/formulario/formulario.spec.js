...
const cliente_entity_1 = require("@modules/gestao_clientes/domain/cliente/cliente.entity");
const vitest_1 = require("vitest");
const pergunta_entity_1 = require("../pergunta/domain/pergunta.entity");
...
(0, vitest_1.describe)("Entidade Formulario", () => {
    ...
    (0, vitest_1.beforeEach)(() => {
        cliente = cliente_entity_1.Cliente.criarCliente({
            pessoa: new pessoa_entity_1.Pessoa({ nome: "João", email: "joao@email.com", telefone: "12345678" }),
            cidade: "Aracaju",
            vendedorResponsavel: "Yago",
            produtos: [
                new produto_entity_1.Produto({ nome: "Tênis de corrida", descricao: "Tênis profissional para quem já tem experiência", valor: 320 })
            ]
        });
        dados = cliente.recuperarDadosEssenciais();
