 ...
 *         description: Erro interno do servidor.
 */
funcionarioRouter.get('/funcionarios', authMiddleware, async (req, res, next) => {
  try {
 ...
 *         description: Erro interno do servidor.
 */
funcionarioRouter.get('/funcionarios/:id', authMiddleware, async (req, res, next) => {
  try {
 ...
 *         description: Erro interno do servidor.
 */
funcionarioRouter.get('/funcionarios/usuario/:usuarioId', authMiddleware, async (req, res, next) => {
  try {
 ...
 *         description: Erro interno do servidor.
 */
funcionarioRouter.put('/funcionarios/:id', authMiddleware, validationMiddleware(AtualizarFuncionarioValidationDTO), async (req, res, next) => {
  try {
 ...
 *         description: Erro interno do servidor.
 */
funcionarioRouter.delete('/funcionarios/:id', authMiddleware, async (req, res, next) => {
  try {
