 ...
 */
formularioRouter.post('/formulario', authenticateToken,formularioController.criar);
 ...
 *         description: Erro interno do servidor.
 */
formularioRouter.get('/formularios', authenticateToken, formularioController.listar);
 ...
 *         description: Erro interno do servidor.
 */
formularioRouter.get('/formulario/:id', authenticateToken, formularioController.buscarPorId);
 ...
 *         description: Erro interno do servidor.
 */
formularioRouter.put('/update-formulario/:id', authenticateToken, formularioController.atualizar);
 ...
 *         description: Erro interno do servidor.
 */
formularioRouter.delete('/delete-formulario/:id', authenticateToken, formularioController.deletar);
