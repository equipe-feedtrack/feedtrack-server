/*
  ...
  - You are about to drop the column `data_admissao` on the `funcionarios` table. All the data in the column will be lost.
  - Added the required column `dataAdmissao` to the `funcionarios` table without a default value. This is not possible if the table is not empty.
